...
export const DEFAULT_FAQS: FaqEntry[] = [
  {
    ...
    a: "Across 121+ retail stores in Assam, Meghalaya, Manipur, Tripura, Mizoram, Nagaland, Arunachal Pradesh, West Bengal, Bihar, and Odisha. Use the Find a Store page to locate your nearest distributor.",
  },
  {
