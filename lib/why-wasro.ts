  ...
  cards: [
    {
      ...
      body: "Red bucket with the 2kg, printed bucket with the 3kg, 40L drum with the 4kg. Real value, every time.",
      stat: "3",
      statLabel: "gift types",
    },
    {
      icon: "Wallet",
      theme: "emerald",
      title: "Honest, value-tier pricing",
      body: "From a ₹5 single-wash sachet to a 4kg jumbo pack with a free drum — quality detergent at prices Indian households actually budget for.",
      stat: "₹5",
