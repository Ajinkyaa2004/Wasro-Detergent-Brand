  ...
  cards: [
    {
      ...
      body: "Free mug with the 500g, bucket or tub with the 2kg, drum or big tub with the 3kg, 40L drum or big basket with the 4kg. Real value, every time.",
      stat: "4",
    ...
    },
    {
      ...
      body: "From a ₹10 sachet to a 4kg jumbo pack with a free basket or drum — quality detergent at prices Indian households actually budget for.",
      stat: "₹5",
